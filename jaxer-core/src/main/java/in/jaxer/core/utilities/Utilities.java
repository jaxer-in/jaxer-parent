...
public class Utilities
{
	...
	{
		if (Validator.isEmpty(urlString))
		{
			return false;
		}
	...
	{
		return Validator.isEmpty(jsonString) ? null : Singletons.getGson(false).fromJson(jsonString, clazz);
	}

	public static <T> List<T> toObjectList(String jsonString, Class<T> clazz)
	{
		return Validator.isEmpty(jsonString) ? null : Collections.toList(jsonString, clazz);
	}
}
